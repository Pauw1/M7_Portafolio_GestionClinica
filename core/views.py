from django.shortcuts import render, get_object_or_404 from django.db.models import Sum from .models import Paciente

def ficha_paciente(request, id): paciente = get_object_or_404(Paciente, id=id) ficha = getattr(paciente, 'ficha', None)
